        ...
        <div className="bg-light dark:bg-dark py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:max-w-4xl">
                    <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl">From the blog</h2>
                    <p className="mt-2 text-lg/8 text-gray-600 dark:text-gray-400">Learn how to grow your business with our expert advice.</p>
                                ...
                                <div>
                                    <div className="flex items-center gap-x-4 text-xs">
                                        ...
                                        <a
                                            ...
                                            className="relative z-10 rounded-full bg-gray-50 dark:bg-gray-900 px-3 py-1.5 font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900"
                                        >
                                            {post.category.title}
                                        </a>
                                    </div>
