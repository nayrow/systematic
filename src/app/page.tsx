      ...
      <div className="bg-gray-900 h-screen">
        <header className="absolute inset-x-0 top-0 z-50">
          ...
          <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
            ...
            <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-light/10">
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div className="text-center">
                ...
                <p className="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">
                  University robotics team from Romania who wants to conquer  the robotics world and innovate with their creativity.
                </p>
